...
const Share = ({onBack, data}) => {
    ...
    return (<>
        ...
        <div className="d-flex mb-4">
            <Button variant="success" onClick={() => onBack('settings')} className="me-2 shadow">Log In</Button>
            <Button variant="primary" onClick={() => onBack('settings')} className="ms-2 shadow">Create Account</Button>
        </div>
        <Button onClick={() => onBack('settings')} className="position-fixed start-0 bottom-0 ms-3 mb-3 shadow">
