...
const Settings = ({onBack, submit, data}) => {
    ...
    const [hide_results, toggleResults] = useState(data.hide_results || false);
    ...
    return (<>
        ...
        <div className="py-1">
            <div onClick={() => submit('dates', {custom: custom, hide_results: hide_results})} className="position-relative">
        ...
        <div className="py-1">
            <div className="position-relative">
                <div className="position-absolute top-50 end-0 translate-middle-y">
                    <Toggler onClick={() => toggleResults(!hide_results)} init={hide_results}/>
                </div>
        ...
        <Button onClick={() => onBack('init')} className="position-absolute bottom-0 mb-3 shadow">
        ...
        <Button variant="success" onClick={()=> handleSubmit()} className="position-absolute bottom-0 end-0 mb-3 shadow">
